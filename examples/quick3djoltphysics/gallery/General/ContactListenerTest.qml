...
Item {
    ...
    property alias bodyIDs: contactListener.bodyIDs
    ...
    PhysicsSystem {
        ...
        contactListener: ExampleContactListener {
            id: contactListener
        }
    ...
    View3D {
        ...
        Body {
            ...
            onBodyIDChanged: bodyIDs.push(body1.bodyID)
        }
        ...
        Body {
            ...
            onBodyIDChanged: bodyIDs.push(body2.bodyID)
        }
        ...
        Body {
            ...
            onBodyIDChanged: bodyIDs.push(body3.bodyID)
        }
    }
